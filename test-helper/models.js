...
scopedModelSchema.plugin(slugHero, {
  doc: 'scoped',
  scope: ['owner'],
  field: 'name'
})
...
advancedScopedModelSchema.plugin(slugHero, {
  doc: 'advancedScoped',
  scope: ['owner'],
  field: 'name'
})
...
multiScopeModelSchema.plugin(slugHero, {
  doc: 'multi-scope',
  scope: ['owner1', 'owner2'],
  field: 'name'
})
...
module.exports = {
  ...
  DottedScopedModel: mongoose.model(
    'dottedScopedModelSchema',
    dottedScopedModelSchema
  )
}
